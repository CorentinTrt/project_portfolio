    ...
    return (
        <div>
            <p style={{ marginBottom: '1.5rem' }}>
                I usually work with modern javascript frameworks or node.js
            </p>
            <p>
                I would be happy to work on the frontend or backend side of your project
            </p>
        </div>
    );
};

const ContactWysiwyg = () => {
    return (
        <div>
...
const NavItems = [
    {
        wysiwyg: <IntroWysiwyg />,
        label: 'Intro',
    },
    {
        wysiwyg: <ContactWysiwyg />,
        label: 'Contact',
    },
    {
        wysiwyg: <RessourcesWysiwyg />,
        label: 'Ressources',
    },
];
